...
# list samples currently in vcf
bcftools query -l bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

bcftools query -f '%CHROM\n'| sort | uniq

# slice to be just the mitochondria
bcftools view bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz --regions Mt | bcftools sort -Oz -o mito_only_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

# count starting variants
bcftools view -H mito_only_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz | wc -l

## Keep samples with 40% of genome covered by 10x reads

bcftools view -S samples_40_10.txt mito_only_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz --min-ac=1 -Oz -o mito_only_miss40_mac_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

# look at the variants 
 zgrep -v '^##' vcfname.vcf.gz | zless
...
bcftools view -M2 -m2 -v snps mito_only_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz -Oz -o mito_only_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

# tabix index the compressed VCF file, creates .vcf.gz.tbi
tabix -p vcf mito_only_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz
...
bcftools view -S samples_40_10.txt mito_only_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz --min-ac=1 -Oz -o mito_only_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

tabix -p vcf mito_only_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

## count variants, gambiae: 21679588
preVARIANTS=$(bcftools view -H mito_only_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz | wc -l)
...
-V mito_only_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz \
...
-O mito_only_gatk_tagged_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz
...
bcftools view -f 'PASS' mito_only_gatk_tagged_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz -Oz -o mito_only_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

## count variants, gambiae: 20037931, melas: 8951325
VARIANTS=$(bcftools view -H mito_only_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz | wc -l)
...
bcftools filter -S . -e 'FMT/DP<5 | FMT/GQ<20' -O z -o mito_only_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz mito_only_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz
...
## happy? index vcf
tabix -p vcf mito_only_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz
...
countVARIANTS=$(bcftools view -H mito_only_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz | wc -l)
...
bcftools filter -e 'AC==0' mito_only_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gzz -O z -o mito_only_AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

tabix -p vcf mito_only_AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

## count variants, gambiae: 19656287 melas: 8901793

countVARIANTSagain=$(bcftools view -H mito_only_AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz | wc -l)
...
bcftools filter -e 'F_MISSING > 0.2 || MAF <= 0.01' -O z -o mito_only_F_MISSING_MAF_AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz mito_only_AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

# check this has worked. The minor allele count should be 1 or above in this dataset.
bcftools query mito_only_F_MISSING_MAF_AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz -f'%AC\n' | sort -g | head

# count variants, gambiae: 16452859 melas: 8489243
variantcount=$(bcftools view -H mito_only_F_MISSING_MAF_AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz | wc -l)
echo "the number of variants after filtering for F_MISSING and MAF is $variantcount"

tabix -p vcf mito_only_F_MISSING_MAF_AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gzz
...
beagle -Xmx500g gt=mito_only_F_MISSING_MAF_AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz out=mito_only_bijagos_gambiae_melas_malariagen_GB_GM-ABC_AgamP4_aligned_phased

tabix -p vcf mito_only_bijagos_gambiae_melas_malariagen_GB_GM-ABC_AgamP4_aligned_phased.vcf.gz
...
# unphased melas: 34
#bcftools query -f '%CHROM\t%POS\n' F_MISSING_MAF_AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz | awk '$1=="2L"' | wc -l
# phased melas:0
