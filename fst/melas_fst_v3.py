...
# python /mnt/storage11/sophie/gitrepos/anopheles_melas/fst/melas_fst_v3.py . /mnt/storage11/sophie/bijagos_mosq_wgs/2019_melas_fq2vcf_gambiae_aligned/genomics_database_melas2019plusglobal/genomics_database_melas2019plusglobal_vcf/melas_2019_plusglobal_filtering/2019melasglobal_finalfiltered_gambiaealigned_phased.zarr 2L
...
def main(args):
    ...
    print(f"Maximum FST Value for {args.chromosome}:", max_value)
    print(f"Corresponding Window (Genomic bps) for {args.chromosome}:", max_window)
    ...
    filtered_array = fst[(~np.isnan(fst)) & (fst > 0)]
