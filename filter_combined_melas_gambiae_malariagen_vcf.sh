...
bcftools view -M2 -m2 -v snps bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz -Oz -o bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

# tabix index the compressed VCF file, creates .vcf.gz.tbi
tabix -p vcf bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

# filter out the contigs from the VCF file, note that to produce a properly bgzipped vcf file you need the -Oz flag
 bcftools view bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz --regions 2L,2R,3L,3R,Mt,X,Y_unplaced | bcftools sort -Oz -o chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

# view the unique chromosome names
bcftools query -f '%CHROM\n' chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz | sort | uniq > unique_chromosomes_filtered.txt
tabix -p vcf chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz
...
bcftools view -S samples_40_10.txt chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz --min-ac=1 -Oz -o miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

tabix -p vcf miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

## count variants, gambiae: 21679588
preVARIANTS=$(bcftools view -H miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz | wc -l)
...
-V miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz \
...
-O gatk_tagged_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz
...
bcftools view -f 'PASS' gatk_tagged_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz -Oz -o gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

## count variants, gambiae: 20037931, melas: 8951325
VARIANTS=$(bcftools view -H gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz | wc -l)
...
bcftools filter -S . -e 'FMT/DP<5 | FMT/GQ<20' -O z -o DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz
...
## happy? index vcf
tabix -p vcf DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz
...
countVARIANTS=$(bcftools view -H DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz | wc -l)
...
bcftools filter -e 'AC==0' DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gzz -O z -o AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

tabix -p vcf AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

## count variants, gambiae: 19656287 melas: 8901793

countVARIANTSagain=$(bcftools view -H AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz | wc -l)
...
bcftools filter -e 'F_MISSING > 0.2 || MAF <= 0.01' -O z -o F_MISSING_MAF_AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz

# check this has worked. The minor allele count should be 1 or above in this dataset.
bcftools query F_MISSING_MAF_AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz -f'%AC\n' | sort -g | head

# count variants, gambiae: 16452859 melas: 8489243
variantcount=$(bcftools view -H F_MISSING_MAF_AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz | wc -l)
echo "the number of variants after filtering for F_MISSING and MAF is $variantcount"

tabix -p vcf F_MISSING_MAF_AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gzz
...
beagle -Xmx500g gt=F_MISSING_MAF_AC0_DP5_GQ20_gatk_filtered_miss40_mac_chr_bi_snps_bijagos_gambiae_melas_malariagen_GB_GM-ABC_alignedtoAgamP4_merged.vcf.gz out=bijagos_gambiae_melas_malariagen_GB_GM-ABC_AgamP4_aligned_phased
